...
cd ..
zip -r plugin.video.onf.extended.zip plugin.video.onf/addon.xml plugin.video.onf/fanart.jpg plugin.video.onf/icon.png plugin.video.onf/LICENCE plugin.video.onf/main.py plugin.video.onf/url_web.py
cd plugin.video.onf
