...
class GetWebTests(unittest.TestCase):
    ...
    def test_get_videos_nouvellement_en_ligne(self):
        ...
        my_categories = url_web.get_categories()
        if nouvellementenligne in my_categories:
            self.assertGreater(len(url_web.get_videos(nouvellementenligne)), 100, "La catégogie '" + nouvellementenligne + "' contient moins de 100 éléments...")
        else:
